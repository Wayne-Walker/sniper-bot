...
class SmartMoneyBot:
    ...
    def run_global(self) -> str:
        ...
        report, saved   = self.reporter.global_report(analysis, self._winners, self._losers)
        print(report)
        print(f"\n  ✅ Report saved → {saved}\n")
    ...
    def run_coin(self, coin: str) -> str:
        ...
        report, saved   = self.reporter.coin_report(coin, sentiment, self._winners, self._losers)
        print(report)
        print(f"\n  ✅ Report saved → {saved}\n")
        return report
